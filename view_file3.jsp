...
if(rtt.next()){
      ...
      session.setAttribute("ssspatient_id", rtt.getString("patient_id"));
       session.setAttribute("ssspname", rtt.getString("pname"));
        session.setAttribute("sssgender", rtt.getString("gender"));
         session.setAttribute("sssage", rtt.getString("age"));
          session.setAttribute("ssspdob", rtt.getString("pdob"));
           session.setAttribute("ssspmail", rtt.getString("pmail"));
           session.setAttribute("sssdoctor_id", rtt.getString("doctor_id"));
         session.setAttribute("sssdoctor_name", rtt.getString("doctor_name"));
        session.setAttribute("ssspoci", rtt.getString("poci"));
       session.setAttribute("sssrfv", rtt.getString("rfv"));
      session.setAttribute("sssmedications", rtt.getString("medications"));
     session.setAttribute("sssimmunizations", rtt.getString("immunizations"));
    
    System.out.println("b "+rtt.getString("medications")+rtt.getString("immunizations")+rtt.getString("rfv"));
    ...
    System.out.println(" hello "+sbb.toString());
