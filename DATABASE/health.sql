-- MySQL dump 10.10
--
-- Host: localhost    Database: health_information
-- ------------------------------------------------------
...
--
-- Table structure for table `integrate`
--

DROP TABLE IF EXISTS `integrate`;
CREATE TABLE `integrate` (
  `doc_info` varchar(100) default NULL,
...
CREATE TABLE `upload` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `doc_info` varchar(2000) default NULL,
...
--
-- Table structure for table `uploadb`
--
